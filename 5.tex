...
方的景物悬在空中（图5.27）．
\begin{figure}[htp]\centering
    \includegraphics[scale=.45]{fig/5-27.png}
    \caption{海市蜃楼}
    \end{figure}
...
水源而奔向前去，但总是可望而不可及．
\begin{figure}[htp]\centering
    \includegraphics[scale=.45]{fig/5-28.png}
    \caption{沙漠里的海市蜃楼}
    \end{figure}
...
\begin{figure}[htp]\centering
    \includegraphics[scale=.45]{fig/5-30.png}
    \caption{}
    \end{figure}
\end{enumerate}
...
\end{figure}
 ...
 \section{透镜成像}
    ...
    烛焰的像能成在光屏上．
    \begin{figure}[htp]\centering
        \includegraphics[scale=.45]{fig/5-38.png}
        \caption{研究透镜成像}
        \end{figure}
...
\begin{figure}[htp]\centering
    \includegraphics[scale=.45]{fig/5-53.png}
    \caption{显微镜的成像光路图}
    \end{figure}
...
远镜的物镜焦距较长，目镜焦距较短．
\begin{figure}[htp]\centering
    \includegraphics[scale=.45]{fig/5-54.png}
    \caption{开普勒望远镜原理图}
    \end{figure}
...
上已有口径为5米的反射式望远镜．
\begin{figure}[htp]\centering
    \includegraphics[scale=.55]{fig/5-55.png}
    \caption{反射式望远镜原理图}
    \end{figure}
...
\subsection*{电子显微镜}
    ...
    \begin{figure}[htp]
        ...
        \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[scale=.55]{fig/5-56.png}
        \end{minipage}
        \begin{minipage}[t]{0.48\textwidth}
        \centering
